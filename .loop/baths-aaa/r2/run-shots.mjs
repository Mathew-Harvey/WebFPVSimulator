 ...
 * Round 2 recapture after r1 MUST-FIX for the Municipal baths AAA loop.
 */
...
const steps = [
  ...
  ...park(14, 4, 8, 26, 6, 0),
  'shot:tower',
  ...park(24.2, -1.8, -5.22, 26.2, -1.8, -5.22),
  'shot:hopper',
  overlay(27, -8, 14),
  'until:window.__boot().frames>=window.__camMark+5',
  'shot:hopper-boxes',
  ...
  'shot:west-door',
  ...park(0, 8.3, 10.2, -7.4, 2.85, 0),
  'shot:gallery',
  ...park(-13.5, 16.6, 0, -13.5, 4, 0),
  'shot:well',
  ...park(0, 42, 28, 0, 8, 0),
  'shot:aerial',
  ...park(0, 3.2, 26, 0, 0.6, 19),
  'shot:plaza',
  ...park(12, 1.55, 8.2, 12, 1.15, 12.4),
  'shot:hall-close',
  `eval:${INSTALL}`,
