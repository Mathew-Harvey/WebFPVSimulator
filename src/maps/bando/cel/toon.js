...
/*
 * Drop cached materials and ramps after a map dispose. disposeSceneGraph
 * already freed the GPU objects; leaving them in these maps would hand the
 * next build disposed materials.
 */
