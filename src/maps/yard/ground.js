...
export function buildGround(root, colliders, M) {
  ...
  decal(root, colliders, M.gravel, -20.4, 0.03, 6.2, -18.6, 0.055, 18.4);
  decal(root, colliders, M.gravel, -10.8, 0.03, -8.8, -6.6, 0.055, -4.8);
  decal(root, colliders, M.asphalt, 6.8, 0.03, -8.4, 10.6, 0.055, L.garage.z0);
  decal(root, colliders, M.gravel, -32.2, 0.03, 24.0, -19.8, 0.05, 30.5);
  ...
  decal(root, colliders, M.dry, -10, 0.03, 10, 4, 0.05, 18);
  decal(root, colliders, M.hayShade, -32.4, 0.04, 12.05, -20.6, 0.07, 15.8);
  decal(root, colliders, M.hayShade, -31.8, 0.04, 24.05, -20.1, 0.07, 30.4);
  ...
  decal(root, colliders, M.litter, -33.9, 0.04, 24.3, -32.1, 0.08, 25.2);
