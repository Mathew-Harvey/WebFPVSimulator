/*
 * sky.js: painted dome and flat cel clouds for the yard.
 *
 * Same three-stop quantised dome as the other freestyle maps, retinted
 * to a warmer evening so the cream house reads against it.
 *
...
export function buildDistantHills(root, M) {
  const layers = [
    { z: -280, h: 42, mat: M.hillFar, width: 720, bumps: 8, y: -8 },
    { z: -200, h: 30, mat: M.hill, width: 620, bumps: 6, y: -6 },
  ];
