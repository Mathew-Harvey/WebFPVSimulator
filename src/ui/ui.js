 ...
 * or null when the summary does not carry one. A number, or an object
 * holding one as `counter` (or `total`), so the scorer's shape for it can
 * settle without this reading nothing. */
